...
result_sub_path = result_path + 'part1d/'
...
outlier_percent = [10, 25]
num_sub_sample = 5

sample_data_list = []
for i in range(2):
    for j in range(num_sub_sample):
        sample_data = DataSet(sample_x_path, sample_y_path, percent_outlier=outlier_percent[i])
        sample_data_list.append(sample_data)

for sample_id in range(2 * num_sub_sample):
